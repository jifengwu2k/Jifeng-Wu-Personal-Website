...
- [`progress-display`](https://github.com/jifengwu2k/progress-display) — A small single-header C++ progress display for terminal output.
...
- [`create-inspect-typeddict`](https://github.com/jifengwu2k/create-inspect-typeddict) — Compatibility helpers for creating and inspecting TypedDict types.
...
- [`get-args-and-origin`](https://github.com/jifengwu2k/get-args-and-origin) — Compatibility helpers for typing.get_origin() and typing.get_args() on Python < 3.8.
...
- [`pyssa`](https://github.com/jifengwu2k/pyssa) — An executable, source-oriented, stable intermediate representation for Python.
...
- [`pyqtcompat`](https://github.com/jifengwu2k/pyqtcompat) — A single-module Qt binding compatibility layer for PyQt6, PySide6, PyQt5, PySide2, PyQt4, and PySide.
...
- [`txthighlight`](https://github.com/jifengwu2k/txthighlight) — A tiny local web app for highlighting and commenting on plain text files.
- [`yoloroom`](https://github.com/jifengwu2k/yoloroom) — A Qt-based application for reviewing and exporting Ultralytics YOLO object detection results on images within a Photoshop/Lightroom-inspired interface.
...
- [`procsock`](https://github.com/jifengwu2k/procsock) — A small tool for running and tracking background processes over a local TCP port.
...
- [`sshserve`](https://github.com/jifengwu2k/sshserve) — A userland non-daemon SSH server inheriting current user privileges, with shell, exec, SFTP, and TCP forwarding on POSIX systems.
- [`sshshim`](https://github.com/jifengwu2k/sshshim) — SSH connection reuse through a temporary localhost SSH endpoint.
...
- [`chat-completions-conversation-with-tools`](https://github.com/jifengwu2k/chat-completions-conversation-with-tools) — Chat Completions conversation helper with tool support for Python 2 and Python 3.
- [`lucaprot-simplified`](https://github.com/jifengwu2k/lucaprot-simplified) — A simplified implementation derived from Alibaba's LucaProt for protein function prediction from sequence and structural information.
